...
<header>
    ...
    <div class="menu_side">
        <h1>MUSIC ATLAS</h1>
        <div class="playlist">
            <h4 class="active"><span></span><i class="bi bi-music-note-beamed"></i> TOP 5</h4>
    ...
    <div class="master_play">
        ...
        <img src="img/cupid.jpg"alt="coldplay"  id="poster_master_play">
        <h5 id="title">Cupid<br>
